  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.formGroup}>
        ...
        <TextInput placeholder="Title" value={eventTitle} onChangeText={setEventTitle} style={styles.input} />
        <TextInput placeholder="Description" value={eventDescription} onChangeText={setEventDescription} style={styles.input} />
        <TextInput placeholder="Food Type" value={foodType} onChangeText={setFoodType} style={styles.input} />
        <TextInput placeholder="Price Type" value={priceType} onChangeText={setPriceType} style={styles.input} />
