...
app.get('/api/events', async (req, res) => {
    try {
        const results = await pool.query('SELECT * FROM Event WHERE (food_type = (SELECT food_preference FROM Preferences) AND price_type = (SELECT price_preference FROM Preferences)) ORDER BY (num_upvotes-num_downvotes) DESC;');
