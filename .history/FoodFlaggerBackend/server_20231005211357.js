...
app.post('/api/post_event', async (req, res) => {
    try {
        ...
        const results = await pool.query('INSERT INTO Event (event_id, host_uid, title, description, start_time, end_time, food_type, price_type, num_upvotes, num_downvotes) VALUES ($1, $2, $3, $4, $5, $6, $7, $8, 0, 0)', [event_id, host_uid, title, description, start_time, end_time, food_type, price_type]);
